...
class Worker extends SwingWorker<Void, Void> {
    ...
    private SwaggerParserTab tab;
    private IBurpExtenderCallbacks callbacks;
    private int status;

    public Worker(Parser parser, IContextMenuInvocation invocation, SwaggerParserTab tab, IBurpExtenderCallbacks callbacks) {
        JProgressBar progressBar = new JProgressBar();
        progressBar.setString("Parsing Swagger definition");
